    ...
    const register = () => {
        fetch(`${process.env.REACT_APP_API_URL}users/Register`, {
            ...
            body: JSON.stringify({
                ...
                password_confirmation:confirmpasswordRef,
            }),
            headers: {
                ...
                <div className="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div className={`${classes.register} my-5 p-5`}>
                        ...
                        <div className='form-field mb-3'>
                            ...
                            <input type='email' ref={nameRef} id="name" className='form-control' />
                        </div>
                        <div className='form-field mb-3'>
                        ...
                        <div className='form-field mb-3'>
                            <label htmlFor='password' className='mb-2'>Password Confirmation</label>
                            <input type='password' ref={confirmpasswordRef} id="confirmPassword" className='form-control' />
                        </div>
